...
- Слой представления (Presenter) отвечает за управление взаимодействием между слоем данных и отображения, а также за обработку действий пользователя. Код, отвечающий за слой представления находится в корневом файле index.ts, где взаимодействие слоя данных и отображения будет осуществляться с помощью событий генерируемых EventEmitter.
